...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'ProteinStructureUtils'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from ProteinStructureUtils.ProteinStructureUtilsImpl import ProteinStructureUtils  # noqa @IgnorePep8
impl_ProteinStructureUtils = ProteinStructureUtils(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_ProteinStructureUtils.import_rcsb_structures,
                             name='ProteinStructureUtils.import_rcsb_structures',
                             types=[dict])
        self.method_authentication['ProteinStructureUtils.import_rcsb_structures'] = 'required'  # noqa
        ...
        self.rpc_service.add(impl_ProteinStructureUtils.query_rcsb_annotations,
                             name='ProteinStructureUtils.query_rcsb_annotations',
                             types=[dict])
        self.method_authentication['ProteinStructureUtils.query_rcsb_annotations'] = 'required'  # noqa
